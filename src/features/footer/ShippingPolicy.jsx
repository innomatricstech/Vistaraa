...
const ShippingPolicy = () => {
  ...
  // --- Gmail compose link ---
  const gmailLink = `https://mail.google.com/mail/?view=cm&fs=1&to=tajzaheer786@gmail.com&su=Shipping%20Inquiry&body=Hello%20tajzaheer786@gmail.com,%0A%0AI%20have%20a%20question%20regarding%20shipping.%20Please%20assist.%0A%0AThank%20you!`;
    ...
    <div className="shipping-policy-page">
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <p className="mb-6 text-gray-700">
          At <strong>Vistaraa</strong>, we are committed to delivering your orders quickly and efficiently. 
